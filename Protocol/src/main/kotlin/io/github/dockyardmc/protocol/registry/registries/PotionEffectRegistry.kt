...
object PotionEffectRegistry: Registry {
    ...
    override fun get(identifier: String): PotionEffect {
        return potionEffects[identifier] ?: throw RegistryException(identifier, getMap().size)
    }
    ...
    override fun getByProtocolId(id: Int): PotionEffect {
        return potionEffects.values.toList().getOrNull(id) ?: throw RegistryException(id, getMap().size)
    }
