...
object WolfVariantRegistry: DynamicRegistry {
    ...
    override fun get(identifier: String): WolfVariant {
        return wolfVariants[identifier] ?: throw RegistryException(identifier, getMap().size)
    }
    ...
    override fun getByProtocolId(id: Int): WolfVariant {
        return wolfVariants.values.toList().getOrNull(id) ?: throw RegistryException(id, getMap().size)
    }
