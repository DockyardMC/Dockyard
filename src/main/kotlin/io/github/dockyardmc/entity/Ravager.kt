...
class Ravager(location: Location): Entity(location) {
    ...
    fun playAttackAnimation(players: Collection<Player> = viewers) {
        players.sendPacket(ClientboundEntityEventPacket(this, EntityEvent.RAVAGER_ATTACK_ANIMATION))
    }

    fun playAttackAnimation(vararg players: Player) {
        playAttackAnimation(players.toList())
    }
